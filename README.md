...
## Usage
To run, double click RLModSetup.py or run from command line with the file's directory as working directory. For users who don't have a Python installation, a .exe is contained in 'dist'.
